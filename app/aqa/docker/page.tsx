  ...
  return (
    <div className="container">
      ...
      <div className="projectWrapper" style={{ order: 2, width: '100%' }}>
        ...
        <p>
          <a href="https://github.com/MarinaShvachko/AqaNotes.git" target="_blank" rel="noopener noreferrer">My examples of code on the Github</a>
        </p>
        ...
        <p>
          <a href="https://github.com/SeleniumHQ/docker-selenium#quick-start" target="_blank" rel="noopener noreferrer">Official documentation</a>
        </p>
        <p>My examples of code are in a package <b>\src\test\java\docker\_1_startTestInFirefox</b></p>
        
        <h3>1. Download</h3>
        <p>
          <a href="https://docs.docker.com/desktop/windows/install/" target="_blank" rel="noopener noreferrer">Download "Docker Desktop on Windows"</a>. Just double click on the downloaded file and run the installer.
        </p>
        <p>For fast checking that Docker is successfully installed open terminal in Windows and run a command <code>docker --version</code></p>
        ...
        <p>To check container's Id run in Windows terminal <code>docker ps</code></p>
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        <p>Go to <a href="http://localhost:7900/" target="_blank" rel="noopener noreferrer">http://localhost:7900</a> and connect with a password "secret". Start the test. You will see how browser Firefox is opened and code from the test is executed. You can see it only while test is executing. For longer execution I added Thread.sleep(5000).</p>
        <p className="note">
          NOTE: Test execution can be seen only if container starts including "-p 7900:7900" <code>docker run -d -p 4444:4444 <b>-p 7900:7900</b> --shm-size="2g" selenium/standalone-firefox:4.2.1-20220531 </code>
        </p>
        
        <h3>7. Stop container</h3>
        <p>To stop container use: <code>docker stop put_here_id</code></p>
        
        <h4> Run the same test in different browsers</h4>
        <p><a href="https://github.com/SeleniumHQ/docker-selenium#hub-and-nodes" target="_blank" rel="noopener noreferrer">Official documentation</a></p>
        ...
        <p>
          ...
          <a href="http://localhost:4444/ui#/sessions" target="_blank" rel="noopener noreferrer">
        ...
        <p>Get to know ids by command <code>docker ps</code></p>
        <p>Stop nodes and hub run <code>docker stop put_here_id</code></p>
        <p>Remove the grid network run <code>docker network rm grid</code></p>
        
        <h4>SET UP DOCKER VIA DOCKER COMPOSE FILE</h4>
        <p><a href="https://github.com/SeleniumHQ/docker-selenium#docker-compose" target="_blank" rel="noopener noreferrer">Official documentation</a></p>
        <p>My examples of code are in a package <b>\src\test\java\docker\_3_DockerCompose</b></p>
        
        <h3>1. Create a Grid with a Hub and Nodes</h3>
        <p>
          Copy the docker-compose-v3.yml file Version 3 from <a href="https://github.com/SeleniumHQ/docker-selenium#docker-compose" target="_blank" rel="noopener noreferrer">https://github.com/SeleniumHQ/docker-selenium#docker-compose</a>, open it in a text editor and save on a PC. There are settings to start browsers and a selenium-hub, so you don't need to run separate command in Windows terminal anymore. I deleted settings for Edge browser and saved .yml file in the project <b>\src\test\java\docker\_3_DockerCompose\docker-compose-v3.yml</b>
        </p>
        <p>In a Windows terminal go to a folder where you saved the docker-compose-v3.yml file and run <code>docker-compose -f docker-compose-v3.yml up</code></p>
        
        <h3>2. Run testng.xml</h3>
        <p>Start tests by runnin testng.xml and watch creation of sessions in the same way as earlier <a href="http://localhost:4444/ui#/sessions" target="_blank" rel="noopener noreferrer">http://localhost:4444/ui#/sessions</a>. Again 2 sessions are created, one for Firefox and one for Chrome.</p>
        
        <h3>3. Stop containers and remove Grid</h3>
        <p>in Windows terminal:</p>
        <p>Run <code>Ctrl + c</code> </p>
        <p>Run <code>docker-compose -f docker-compose-v3.yml down</code></p>
